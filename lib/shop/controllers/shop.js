...
exports.addItems = function(req, res) {
  // body is empty
  // req.body.items would include a string, but not the [json object]
...
exports.deleteList = function(req, res) {
  shoppingList.deleteList(req.body.listName, function(result) { res.json(result); });
};

exports.updatePrice = function(req, res) {
  shoppingList.updatePrice(req.params.listName, req.body.itemToUpdate, function(result) { res.json(result); });
};
