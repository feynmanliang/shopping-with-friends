...
app.delete('/lists/:listName/:itemId', app.callbacks.deleteItem);

// Delete a shopping list completely
app.delete('/lists/:listName', app.callbacks.deleteList);

// SplitBill
app.get('/lists/:listName/splitBill', app.callbacks.splitBill);

// updatePrice
// req.params.listName = name of the list
// req.body._id = id of item whose price i want to update
// {_id: idOfItem, newPrice: numbervalue}
